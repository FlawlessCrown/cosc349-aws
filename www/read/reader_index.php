	...
	<body>
		<section>
			...
			<form action="deleteuser.php" method="post">
				...
				<input type="text" name="userid"  required="required" pattern="[A-Za-z0-9 ]{1,9}" maxlength="9" id="userid" maxlength="9">
			</form>
			<form action="reader_index.php" method="post">
				...
				<?php
					...
					echo "<input type='text' name='userid' id='userid' required='required' pattern='[A-Za-z0-9 ]{1,9}' maxlength='9' value='$userid' autofocus onfocus='this.select();'/>";
				?>
			</form>
			<table border="1">
				<?php
